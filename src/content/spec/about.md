...
他人とのインタラクションと飲酒が大好きです。  
お酒はウィスキーとワインが好き。度数20%ぐらいまでならがぱがぱ飲める。

いろいろなことに興味関心があります。気になったことは気が済むまで調べる派。    
最近は機械学習による画像認識に興味があります。PyTorchとたたかうぞ！  
→ (2025/07) 課題で触りました。~~記事 → 画像分類モデルを自作してみた~~ 記事はそのうち移植します。
...
- 画像識別モデルを自作してみた (厳密には転移学習だが)
- **内定を得た** 最高
- カラオケにハマった
  - DAM派です。JOYSOUNDも好きだけどテク周りガバガバすぎてなぁ

### 2026年

- 専門学校を卒業した
  - これで完全に学生の身分を脱した  
    これまでの人生20年間ふりかえり記事はそのうち書きます
- 就職した
- M5 Macbook Air を買った
  - 吊るしモデル。ホントはUS配列にしたかったけど、2週間だか待つのはしんどいからJP配列
- GitHub Pages を Hexo から Astro + Fuwari に移行した
  - また？？これで最後にしたいなぁ  
    記事 → [新しいフレームワークに変えてみたよ](../posts/new_framework/)
- Meta Quest Pro を買った
  - フェイトラ目的9割、コントローラーの輪っか除去1割  
    ミスって17万ちょい一括決済してしまった...
  - レビュー記事はそのうち
